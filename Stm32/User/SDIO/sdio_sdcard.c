...
SD_Error SD_PowerON(void)
{
  ...
  SDIO_InitStructure.SDIO_ClockBypass =SDIO_ClockBypass_Enable;  //��ʹ��bypassģʽ��ֱ����HCLK���з�Ƶ�õ�SDIO_CK
...
//cnt:��������	
//����ֵ:����״̬;0,����;����,�������;	
u8 SD_WriteDisk_1(u8*buf,u8 block_address)
{
	u8 sta=SD_OK;
//	u8 n;
	if((u32)buf%4!=0)
	{
		...
		// {
		memcpy(SDIO_DATA_BUFFER,buf,512);
		sta=SD_WriteBlock(SDIO_DATA_BUFFER,block_address,512);//����sector��д����
		// } 
	} else {
		sta=SD_WriteBlock(buf,block_address,512);    	//����sector��д����
	}
	return sta;
}
